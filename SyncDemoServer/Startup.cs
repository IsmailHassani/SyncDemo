...
using SyncDemoServer.Extensions;
using SyncDemoServer.Hubs;

namespace SyncDemoServer
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options => {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Version = "v1",
                    Description = "XYZTEC Synchronization Service",
                    Contact = new OpenApiContact
                    {
                        Name = "XYZTEC Support",
                        Email = "support@xyztec.com",
                        Url = new Uri("https://www.xyztec.com")
                    }
                });
            });
        }
